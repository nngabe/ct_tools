...
PagesDropdown_Button = browser.find_element_by_css_selector('#sel4GW_chzn > a:nth-child(1) > div:nth-child(2)').click()
sleep(1)
NewNeutral_Button = browser.find_element_by_css_selector('#sel4GW_chzn_o_19').click()
